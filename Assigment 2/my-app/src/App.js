...
<body>
    ...
    <h2>Education</h2>
    <p>
        Hello and welcome to my second html project. This is my 6th year of college, 3 years at Mt. SAC 
        ...
        recent education, I've attended the following schools.
    </p>
    <div id="schools">
        <div id="names">
    <ol>
    ...
    <h2>Fun</h2>
    <p>
        With my focus on Game design, you may have guessed that in my spare time I play games. I play a wide range of games 
        from fps, to puzzle games, but my personal favorite are medieval fantasy RPGs. Some day, I hope to make a grand AAA 
        adventure game that people can explore and enjoy. For now, I get to enjoy them. The following are games that I've been playing recently. 
    </p>
    <div id="games">
        <div id="names">
            <ul>
    ...
    <p>
        I suppose this as good of a place as any. Just to let you know I am a disabled student. I have a vision impairment that causes me to 
        lose details at a distance. If you're really curious it's called Juvenile Macular Dystrophy, or the more commnon name BEST's disease 
        after the person who first identified it. Basically just a growing blind spot in the center of my vision. I won't likely require 
        anything special, which is why there was no notification through the disabled student sytem. I'll just sit near the front as I usually do.
    </p>

    <div id="footer">
        <a href="https://github.com/BWilkening/CSE-4500-classwork">
            GitHub Repo
        </a>
    </div>
</body>
